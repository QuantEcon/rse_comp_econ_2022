...
\title{RSE Computational Economics Workshop}

\author{An introduction to computational methods \\ for economics and finance}


\date{10:00am -- 12:00am 22nd July 2022}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \green{Aakash Choudhury (RSE, Developer)}
            \vspace{0.5em}
        \item \green{Shu Hu (RSE, PhD student)}
            \vspace{0.5em}
        \item \green{John Stachurski (RSE, Professor)}
            \vspace{0.5em}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \vspace{0.5em}
        \item Installation of Anaconda Python
        \vspace{0.5em}
